...
db.once('open', async () => {
  ...
  const bouquets = await Bouquet.insertMany([
    ...
    //   occasion: occasions[5]._id,
    //   description:
    //     'As the largest arrangement our store has to offer, this bouquet features hydrangas, roses, daisies, and babies breath.',
    //   image: 'b13.jpg',
    //   price: 90.00,
    //   featured: true
    // },
